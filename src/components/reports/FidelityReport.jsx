...
const FidelityReport = () => {
  return (
    <Wrapper>
      ...
      <CollectionGraph>
        <Typography> Fidelity Collections</Typography>
        <div style={{ height: "100%", width: "100%" }}>
          <AreaGraph data={collectedDSE} dataKey="csdr" />
        </div>
      </CollectionGraph>
      <PaidGraph>
        <Typography> Fidelity Paid</Typography>
        <div style={{ height: "100%", width: "100%" }}>
          <AreaGraph data={paidDSE} dataKey="csdr" />
        </div>
      </PaidGraph>
    </Wrapper>
  );
